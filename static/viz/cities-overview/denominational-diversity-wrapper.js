// Wrapper for denominational-diversity visualization
// This provides the params context for the viz

import * as Plot from "@observablehq/plot";
import citiesTotal from "./city-total-membership.data.js";

const width = 800;
const targetId = "denominational-diversity";
...
document.getElementById(targetId).appendChild(denominationsPlot);
